...
&emsp;&emsp;本书在线版本地址为<https://929hz.com>。 在线版获得更好的阅读体验，并更新最新巡演场Talking，在线版为彩色最新版，不仅对talking重要部分进行着色区分，而且添加链接引用，相关引用可直接跳转，在线版还可以发表评论。当然，你不必一口气读完此书，但相信只要你去过9.29Hz巡演现场，这本书中都会有你的回忆，所以，用深深的话说，就是“**只要你们想我的时候就可以打开那个文档**”。
